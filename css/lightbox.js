...
!function (st, ot, E) {
	...
	st.fn.simpleLightbox = function (N) {
		N = st.extend({
				...
				disableScroll: !0,
				alertError: !0,
				alertErrorMessage: "Resim bulunamadı.",
				additionalHtml: !1,
				history: !0,
				throttleInterval: 0,
				doubleTapZoom: 2,
		...
		tt = function (o) {
			if (K.length) {
				...
				l.onload = function () {
					...
					U = !0;
					var n,
					i = "self" == N.captionSelector ? $.eq(V) : $.eq(V).find(N.captionSelector);
		...
		C = function () {
			...
			_.on("touchstart." + G + " mousedown." + G, function (t) {
				...
				if ("mousedown" == (t = t.originalEvent).type)
					c = t.clientX, p = t.clientY, e = _.height(), a = _.width(), s = K.height(), o = K.width(), n = _.position().left, i = _.position().top, l = parseFloat(K.data("translate-x")), r = parseFloat(K.data("translate-y")), R = !0;
				else {
					if (I = t.touches.length, c = t.touches[0].clientX, p = t.touches[0].clientY, e = _.height(), a = _.width(), s = K.height(), o = K.width(), n = _.position().left, i = _.position().top, 1 === I) {
						if (F)
							return K.addClass("sl-transition"), Y = Y ? (z(0, 0, W = 1), at("0px", "0px", W), !1) : (W = N.doubleTapZoom, z(0, 0, W), at("0px", "0px", W), st(".sl-caption").fadeOut(200), !0), setTimeout(function () {
						...
						2 === I && (h = t.touches[1].clientX, d = t.touches[1].clientY, l = parseFloat(K.data("translate-x")), r = parseFloat(K.data("translate-y")), C = (c + h) / 2, w = (p + d) / 2, u = Math.sqrt((c - h) * (c - h) + (p - d) * (p - d)));
					R = !0
				}
				...
				if (t = t.originalEvent, H && "touchend" == t.type && (0 === (I = t.touches.length) ? (z(W, x, b), 1 == W && (Y = !1, st(".sl-caption").fadeIn(200)), u = null, R = !1) : 1 === I ? (c = t.touches[0].clientX, p = t.touches[0].clientY) : 1 < I && (u = null)), A) {
					var e = !(A = !1);
					N.loop || (0 === V && L < 0 && (e = !1), V >= $.length - 1 && 0 < L && (e = !1)),
				...
				Y ? (z(0, 0, W = 1), at("0px", "0px", W), Y = !1, st(".sl-caption").fadeIn(200)) : (W = N.doubleTapZoom, z(0, 0, W), at("0px", "0px", W), st(".sl-caption").fadeOut(200), Y = !0),
				setTimeout(function () {
					K.removeClass("sl-transition")
				}, 200),
				!(R = !0)
		...
		it = function () {
			if (!m) {
				...
				N.history && (s ? history.pushState("", E.title, o.pathname + o.search) : o.hash = "", clearTimeout(h)),
		...
		N.showCounter && 1 < $.length && (c.appendTo(b), c.find(".sl-total").text($.length)),
		N.nav && J.appendTo(b),
		...
		N.enableKeyboard && st(E).on("keyup." + G, t(function (t) {
				...
				U && (t.preventDefault(), 27 == e && it(), 37 != e && 39 != t.keyCode || nt(39 == t.keyCode ? 1 : -1))
			}, N.throttleInterval)),
